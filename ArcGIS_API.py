    ...
    def processFeatureLayer(generalArcGIS, etlInstance, dmInstance):
        ...
        try:
            ...
            if etlInstance.AGOLDownload == 'Yes':
                ...
                outzipPath = r'C:\Users\KSherrill\OneDrive - DOI\SFAN\VitalSigns\Salmonids\Natural\_Fish\Salmonids\Data\ETL\2025\Smolts\SFAN_Salmonids_Smolts2025v1_20250529-122755.zip'
                outName = 'SFAN_Salmonids_Smolts2025v1_20250529-122755'
