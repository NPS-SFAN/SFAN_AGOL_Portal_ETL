    ...
    def processFeatureLayer(generalArcGIS, etlInstance, dmInstance):
        ...
        try:
            ...
            # Use when developing - don't need to download the AGOl data each time
                ...
                outzipPath = r'C:\Users\KSherrill\OneDrive - DOI\SFAN\VitalSigns\SnowyPlovers_PORE\SNPLOVER\SNPL_IM\Data\ETL\2026\SFAN_SNPLPORE_Survey2026v1.0_20260922-145908.zip'
                outName = 'SFAN_SNPLPORE_Survey2026v1.0_20260922-145908'
