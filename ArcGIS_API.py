    ...
    def processFeatureLayer(generalArcGIS, etlInstance, dmInstance):
        ...
        try:
            ...
            # Use when developing - don't need to download the AGOl data each time
                ...
                outzipPath = r'C:\Users\KSherrill\OneDrive - DOI\SFAN\VitalSigns\SnowyPlovers_PORE\SNPLOVER\SNPL_IM\Data\ETL\2025\SFAN_SNPLPORE_Survey2025v1.2_20260421-161635.zip'
                outName = 'SFAN_SNPLPORE_Survey2025v1.2_20260421-161635'
